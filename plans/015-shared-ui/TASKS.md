...
- [~] Subscriptions: hooks + universal load + SPA form migration + delete server form actions (Part A: hooks + tests done; Part B1: list + runs-history done; Part B2a: sources API + new-page migration in-progress)
